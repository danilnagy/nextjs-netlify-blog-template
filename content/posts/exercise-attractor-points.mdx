---
slug: "exercise-attractor-points"
title: "📋 Exercise: Attractor Points"
date: 2023-02-10
author: daniln
tags:
  - grasshopper
...
_Inputting all the points as a List into Python_
...
_Working with DataTrees in Grasshopper_
...
_Creating DataTrees in Python_
...
_Controlling circle radius with an attractor point_
...
_Moving the point to change the circle radii__
...
>
> Once you’ve made the changes, capture a screenshot of your Rhino and Grasshopper window so that the additional component(s) and/or code are visible. Name the file with your UNI and/or name, and upload to: https://www.dropbox.com/request/8NMzRSG1o090fdbUDJTv
